...
const orders = [
	{
		id: "ORD-005",
		contact: { email: "carson.darrin@domain.com", name: "Carson Darrin" },
		lineItems: 8,
		currency: "USD",
		totalAmount: 693,
		status: "completed",
	...
	{
		id: "ORD-004",
		contact: { name: "Fran Perez", email: "fran.perez@domain.com" },
		lineItems: 4,
		currency: "USD",
		totalAmount: 215,
		status: "canceled",
	...
	{
		id: "ORD-003",
		contact: { name: "Jie Yan", email: "jie.yan@domain.com" },
		lineItems: 1,
		currency: "USD",
		totalAmount: 25,
		status: "pending",
	...
	{
		id: "ORD-002",
		contact: { name: "Siegbert Gottfried", email: "siegbert.gottfried@domain.com" },
		lineItems: 5,
		currency: "USD",
		totalAmount: 535,
		status: "completed",
	...
	{
		id: "ORD-001",
		contact: { name: "Miron Vitold", email: "miron.vitold@domain.com" },
		lineItems: 2,
		currency: "USD",
		totalAmount: 19.99,
		status: "completed",
