...
const events = [
	{
		...
		contact: { name: "Marcus Finn", avatar: "/assets/avatar-9.png" },
	...
	},
	{
		...
		type: "payment",
		description: "Purchased subscription",
		contact: { avatar: "/assets/avatar-8.png", name: "Jie Yan" },
	...
	},
	{
		...
		type: "payment",
		description: "Purchased subscription",
		contact: { name: "Sofia Rivers", avatar: "/assets/avatar.png" },
		createdAt: dayjs().subtract(5, "minute").toDate(),
	},
];
					...
					<List disablePadding>
						{events.map((event, index) => (
							<ListItem divider={index < events.length - 1} key={event.id}>
								<ListItemAvatar>
									<Avatar src={event.contact.avatar} sx={{ cursor: "pointer" }} />
								</ListItemAvatar>
								<ListItemText
									disableTypography
									primary={
