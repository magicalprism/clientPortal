        ...
        <div style={{ border: '1px dashed #aaa', padding: '1rem', position: 'relative' }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <InlineEditableField
                ...
                variant="body2"
                placeholder="Descriptive content goes here..."
                multiline
                sx={{ mb: 2 }}
              />
          ...
          {editable && (
            <div style={{
              ...
              💡 <strong>Pro tip:</strong> For advanced media management, use the full section editor to upload files and manage gallery relationships.
            </div>
          )}
        </div>
      );
