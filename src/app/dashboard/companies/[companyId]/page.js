...
import { ShippingAddress } from "@/components/dashboard/contact/shipping-address";

export const metadata = { title: `Details | Company | Dashboard | ${appConfig.name}` };
					...
					>
						<Stack spacing={4}>
							<Card>
								...
								>
									{[
										{ key: "contact ID", value: <Chip label="USR-001" size="small" variant="soft" /> },
